    ...
    return (
        <div className='news'>
            ...
            <div className='info'>
                <div className="text">
                    <h2>Tic Tac Toe</h2>
                    <p>If tic-tac-toe were as simple as it seems, why has it been around for over 3,000 years? Our version has evolved a bit since the original version in ancient Egypt, by letting kids play against the computer. However, what it teaches kids hasn’t changed. This classic game contributes to children’s developmental growth in numerous ways including their understanding of predictability, problem solving, spatial reasoning, hand-eye coordination, turn taking, and strategizing.  Teachers trust Toy Theater to provide safe & effective educational games.
                    </p>
                </div>
            ...
            <div className='info'>
                ...
                <div className="text">
                    <h2>Memory Game</h2>
                    <p>The memory game, or concentration, as it is sometimes called, is a popular card game played by children and adults around the world. Good memory is one of the qualities required in order to succeed in it. This, however, is not enough. When it is assumed that the players have perfect memory, the memory game can be seen as a game of strategy. The game is analysed under this assumption and the optimal strategy is found. It is simple and perhaps unexpected.
            ...
            <div className='info'>
                <div className="text">
                    <h2>Number puzzle</h2>
                    <p>Solving puzzles have been really helpful in developing the brain of a child. Various puzzles help in enhancing the cognitive, spatial and logical abilities of the child.
                        Number puzzles have a specific set of rules; you first have to figure out the pattern being followed and then answer the puzzle according to the pattern. Learn and practice Number puzzles from this article.
                        Number puzzles are a part of many competitive examinations, these also help you improve your logical thinking, and above all these are fun to crack!!!
                    </p>
                </div>
            ...
            <div className='info'>
                <div className="text">
                    <h2>Sapper</h2>
                    <p>Sapper Classic is an online version of the classic Minesweeper game. Minesweeper is one of the first games to become available on PC’s and young and old have grown to love the game over the many years that it has been around. The game is simple, try to find all of the bombs that have been scattered around the game map and flag them with your set of red flags.
